  ...
  useEffect(() => {
    const fetchGuestInfo = async () => {
      try {
        ...
        const response = await fetch(`/api/Forms/Itinerary/${params.reservationid}`);
        if (response.ok) {
              ...
              <TableCell className='space-y-4'>
                {apiData.map((el: any, i) => (
                  <div>
                    ...
                    {
                      el.guestId === params.reservationid && <div>{el.date}</div>
                    }
              ...
              <TableCell className='space-y-4'>
                ...
                {apiData.map((el: any, i) => (
                  <div>
                    ...
                    {
                      el.guestId === params.reservationid && <div>{el.day}</div>
                    }
              ...
              <TableCell className='space-y-4'>
                ...
                {apiData.map((el: any, i) => (
                  <div>
                    ...
                    {
                      el.guestId === params.reservationid && <div>{el.activity}</div>
                    }
              ...
              <TableCell className='space-y-4'>
                ...
                {apiData.map((el: any, i) => (
                  <div>
                    ...
                    {
                      el.guestId === params.reservationid && <div>{el.stay}</div>
                    }
