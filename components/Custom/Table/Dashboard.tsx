...
import { DashboardModal } from "@/components/../app/(routes)/(commonLayout)/dashboard/[dashboardid]/dashboardModal";
...
const Dashboard: React.FC<guestProps> = ({ guestList, Guest }) => {
  ...
  const DeleteGuest = async (id: string) => {
    ...
    if (!res.ok) {
      toast({
        title: "Sales reservation form is not deleted server error",
        variant: "destructive",
      });
    }
    ...
    if (res.ok) {
      router.refresh();
      toast({
        title: "Sales reservation form deleted successfully",
        variant: "default",
      });
      return res.json();
    }
      ...
      cell: ({ row }) => {
        ...
        return (
          <Dialog open={open} onOpenChange={setOpen}>
            <DropdownMenu>
              {/* Removed DropdownMenuTrigger and Button */}
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem className="pr-10 cursor-pointer hover:!bg-success hover:!text-white">
                  <DialogTrigger
                    onClick={() => {
                      router.push(`/reservation/${row.original.id}/EditFormData`);
                    }}
                  >
            ...
            <DashboardModal id={ids} open={open} setOpen={setOpen} />
          </Dialog>
        );
      },
    },
    ...
    <div className="w-full ">
      <div className="flex w-full justify-between items-center py-4">
       ...
       <div className="flex items-center space-x-5">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem>Filed Date</DropdownMenuItem>
        <DropdownMenuItem>Booked Date</DropdownMenuItem>
