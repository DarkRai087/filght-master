...
import GuestEditModal from "@/app/(routes)/(commonLayout)/sales/[salesid]/Components/GuestEditModal";
            ...
            <Dialog>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DialogTrigger className="flex items-center w-full pr-10 cursor-pointer hover:!bg-primary hover:!text-white">
                    <DropdownMenuItem
                      // onClick={() => editGuest(row.original.id)}
                      className="flex items-center w-full pr-10 cursor-pointer hover:!bg-primary hover:!text-white"
                    >
                      <UserPlus2 className="mr-2 h-4 w-6" />
                      Edit  User 
                    </DropdownMenuItem>
                  </DialogTrigger>
              ...
              <GuestEditModal id={row.getValue("id")} />
            </Dialog>
